...
export const method = {
  ...
  CONVERSATION_SET_MODEL: "conversation.set_model",
  ...
  CONVERSATION_COPY_EXAMPLE: "conversation.copy_example",
  ...
  PROJECT_ROOT_ATTACH: "project.root_attach",
  PROJECT_ROOT_REMOVE: "project.root_remove",
  PROJECT_CONVERSATION_CREATE: "project.conversation_create",
  ...
  ARTIFACT_RESOLVE_PATH: "artifact.resolve_path",
  ...
  HARNESS_PROVIDERS_LIST: "harness.providers_list",
  HARNESS_READINESS_RECOMMEND: "harness.readiness_recommend",
  HARNESS_ROSTER_SET_ENABLED: "harness.roster_set_enabled",
  HARNESS_ROSTER_ADD: "harness.roster_add",
  HARNESS_USAGE_LIST: "harness.usage_list",
  HARNESS_INSTALLED_CLIS_LIST: "harness.installed_clis_list",
  HARNESS_PICKER_SETTINGS_GET: "harness.picker_settings_get",
  HARNESS_PICKER_SETTINGS_SET: "harness.picker_settings_set",
  HARNESS_DISCOVERY_SYNC: "harness.discovery_sync",
